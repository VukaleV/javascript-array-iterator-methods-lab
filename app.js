...
// Exercise 1: Filter inventors born in 1500s
let veryOldInventors = inventors.filter(inv => inv.year >= 1500 && inv.year < 1600);
console.log('Exercise 1 my result: ', veryOldInventors);

// Exercise 2: Map inventors to first and last names
let inventorNames = inventors.map(inv => ({ first: inv.first, last: inv.last }));
console.log('Exercise 2 my result: ', inventorNames);

// Exercise 3: Sort inventors by birth year ascending
let sortedByBirthYear = [...inventors].sort((a, b) => a.year - b.year);
console.log('Exercise 3 my result: ', sortedByBirthYear);

// Exercise 4: Find inventor named Ada
let inventorNamedAda = inventors.find(inv => inv.first === 'Ada');
console.log('Exercise 4 my result: ', inventorNamedAda);

// Exercise 5: Reformat names "Last, First" -> "First Last"
